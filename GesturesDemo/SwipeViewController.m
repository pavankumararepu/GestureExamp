...
@interface SwipeViewController (){
   IBOutlet NSString *sivaIM;
}

@property (weak, nonatomic) IBOutlet UIView *viewOange;
@property (weak, nonatomic) IBOutlet UIView *sivaIBM;

@property (weak, nonatomic) UIView *sivaPM;
...
- (void)viewDidLoad
{
    ...
    /*
    sivaIH = [[NSMutableArray alloc]init];
    
    
    self.siva1 = self.siva2;
    _siva4 = self.siva1;
    self.siva3 = _siva4;
    _siva4 = _siva3;
...
-(NSString *)returnSomeValue:(NSString *)givenString
{
    _siva3 = givenString;
